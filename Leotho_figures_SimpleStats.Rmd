...
```{r}
# Import data
df.data <- read.csv("~/Seh 2016 survey recording system_complete_03.17.17.csv", header=T)
...
#import flake data
df.flake <- 
  read.csv("~/sehonghong_flakes.csv", header=T)
...
# Import core data
df.core <- 
  read.csv("~/sehonghong_cores.csv", header=T)
